...
export default function Home() {
  ...
  return (
    <div className="flex flex-1 min-w-0 flex-col md:flex-row w-full gap-2 md:gap-6 items-start justify-start overflow-hidden">
      ...
      {currentPage === "tree" && <ToolBuilderPage />}
    </div>
  );
}
