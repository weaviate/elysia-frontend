...
const DataExplorer: React.FC<DataExplorerProps> = ({ collection }) => {
  const {
    selectedCollection,
    collectionData,
    loadingCollection,
      ...
      <div className="flex flex-col gap-3 items-start justify-start w-full">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            >
              <BreadcrumbPage>{collection && collection.name}</BreadcrumbPage>
            </BreadcrumbItem>
            {selectedCell && (
              <>
                <BreadcrumbSeparator />
        ...
        <div className="flex w-full gap-4 justify-between items-center">
          <div className="flex lg:flex-row flex-col gap-4">
            ...
            <div className="flex items-center justify-start gap-2">
              ...
              <div className="flex items-center justify-start gap-2">
                <Button size="sm">{collection.total} objects</Button>
                {collection.vectorizer && collection.vectorizer != "" && (
                  <Button size="sm">
                    <PiVectorThree />
