...
export default function GlobeControlsPanel({
  ...
  return (
    <div className="fixed right-4 top-4 bg-background_alt text-primary p-4 rounded-lg z-50 max-h-[90vh] overflow-y-auto w-80">
          ...
          <div className="space-y-2">
            <div>
              ...
              <Input
                ...
                onChange={(e) => updateSetting("lightAColor", e.target.value)}
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  updateSetting("lightAIntensity", parseFloat(e.target.value))
                }
                className="w-full"
              />
              <span className="text-xs text-gray-300">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => updateSetting("lightBColor", e.target.value)}
                className="w-full h-8"
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  updateSetting("lightBIntensity", parseFloat(e.target.value))
                }
                className="w-full"
              />
              <span className="text-xs text-gray-300">
          ...
          <div className="space-y-2">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  updateSetting("fresnelMultiplier", parseFloat(e.target.value))
                }
                className="w-full"
              />
              <span className="text-xs text-gray-300">
          ...
          <div className="space-y-2">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  updateSetting("noiseFrequency", parseFloat(e.target.value))
                }
                className="w-full"
              />
              <span className="text-xs text-gray-300">
