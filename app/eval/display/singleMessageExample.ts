  ...
  messages: [
    {
      ...
      payload: {
        ...
        objects: ["Are there any messages in Slack about Verba?"],
      },
    },
    {
      type: "text",
        ...
        objects: [
          {
            conversation_id: 250,
            content:
              "Hey team, I just set up a separate repo for the Verba Docker image. Has anyone thought about the need for an official image from Verba?",
            author: "John",
          ...
          },
          {
            conversation_id: 447,
            content:
              "That’s a good idea! I wonder if the VERBA_URL and VERBA_API_KEY not being set is contributing to this problem.",
            author: "John",
          ...
          },
          {
            conversation_id: 446,
            content:
              "I had this happen too! It might be related to environment variables not being set properly. Are you using VERBA_URL and VERBA_API_KEY?",
            author: "Jaina",
          ...
          },
          {
            conversation_id: 256,
            content:
              "Hey team, has anyone encountered the WebSocket error when using Verba with vLLM?",
            author: "Dalinar",
          ...
          },
          {
            conversation_id: 432,
            content:
              "Hey team! Just wanted to say I love the new features in Verba! 🎉",
            author: "Sofia",
